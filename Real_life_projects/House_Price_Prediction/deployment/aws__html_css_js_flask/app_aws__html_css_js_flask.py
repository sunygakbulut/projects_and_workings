...
def predict():
    ...
    X_new = pd.DataFrame(pd.read_csv(
        "/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction/deployment/aws__html_css_js_flask/X_new_single_row.csv"))
    ...
    model = pickle.load(open(
        "/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction/deployment/aws__html_css_js_flask/best_model_xgbm_final.pkl", "rb"))

    # AWC(EC2)
    # scaler = joblib.load("/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction/deployment/aws__html_css_js_flask/scaler")
