...
# streamlit sharing
# xx = pd.read_csv("/app/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/df_new_grouped.csv")
# AWC(EC2)
# xx = pd.read_csv(
#     "/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/df_new_grouped.csv")
# local
xx = pd.read_csv("df_new_grouped.csv")
...
# streamlit sharing
# X_new = pd.DataFrame(pd.read_csv("/app/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/X_new_single_row.csv"))
# AWC(EC2)
# X_new = pd.DataFrame(pd.read_csv("/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/X_new_single_row.csv"))
# local
X_new = pd.DataFrame(pd.read_csv("X_new_single_row.csv"))
X_new.set_index("date", inplace=True)

df = pd.get_dummies(df).reindex(columns=X_new.columns, fill_value=0)

# streamlit sharing
# model = pickle.load(open("/app/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/best_model_xgbm_final.pkl", "rb"))
# AWC(EC2)
# model = pickle.load(open("/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/best_model_xgbm_final.pkl", "rb"))
# local
model = pickle.load(open("best_model_xgbm_final.pkl", "rb"))

# streamlit sharing
# scaler=joblib.load("/app/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/scaler")
# AWC(EC2)
# scaler = joblib.load("/home/ec2-user/projects_and_workings/Real_life_projects/House_Price_Prediction_in_Turkey_from_Webscrabing_to_Deployment/deployment/streamlit_flask_STREAMLITSHARING/scaler")
# local
